 ...
 *
 * @params {string} format - Either 'printout' or 'json'. Default or invalid value defaults to 'printout'.
 */
(function($, format) {
   ...
   *
   * @param {string} label - The group's total prefix label
   * @param {number} value - The group's total value
   * @param {string} currency - The group's currency for the value
   * @param {int} count - The group's total number of items
   * @param {int} shipped - The group's total number of shipped items
   */
   ...
   *
   * @param {Object} fields - An object containing the field's key name and their corresponding values
   * @param {Object} minlen - An object containing the field's key name and their corresponding minimum length
   */
   ...
   * @param {int} minlen - The desired minimum length. If the string length is less than this value then the remaining length will be padded with spaced
